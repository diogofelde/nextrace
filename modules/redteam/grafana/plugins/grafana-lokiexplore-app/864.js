(self.webpackChunkgrafana_lokiexplore_app =
 ...
 const i = ((e, t) => (t ? Q(e, t.scroll.diff.displacement) : e))(
 e.marginBox,
 r,
 ),
 o = ((e, t, n) =>
 ...
 const e = n[d];
 if (Se(d, i))
 return Ne({ axis: s, moveRelativeTo: e.page, isMoving: a });
 ...
 const l = de(t, r);
 if (!s)
 return l.length ? o(l[l.length - 1].descriptor.id) : null;
 ...
 return (
 s(t[a.start]) || s(t[a.end]) || n(o[a.start]) || n(o[a.end])
 );
 })
 .sort((t, n) => {
 ...
 .filter(
 (e, t, n) =>
 ke(e)[a.crossAxisStart] === ke(n[0])[a.crossAxisStart],
 );
 if (!l.length) return null;
 if (1 === l.length) return l[0];
 const c = l.filter((e) =>
 he(ke(e)[a.start], ke(e)[a.end])(t[a.line]),
 );
 return 1 === c.length
 ? c[0]
 : c.length > 1
 ...
 offset: c,
 selection: l,
 borderBoxCenter: U(e.initial.client.borderBoxCenter, c),
 },
 u = {
 ...
 return { ...e, dimensions: s, viewport: a, current: p };
 ...
 return !ut(e) || n
 ? rt({ state: e, dimensions: r })
 : at({ state: e, dimensions: r });
 };
 function ft(e) {
 ...
 return ut(e)
 ? at({ state: e, viewport: r })
 : rt({ state: e, viewport: r });
 }
 ...
 (r || M(!1),
 (r = null),
 Yt(0, () => Jt(e().onDragEnd, n, t, j.onDragEnd)));
 };
 return {
 beforeCapture: (t, n) => {
 (r && M(!1),
 ...
 const r = e.getState();
 ("DROP_ANIMATING" !== r.phase && M(!1),
 e.dispatch(Ct({ completed: r.completed })));
 };
 var Zt = (e) => {
 let t = null,
 n = null;
 ...
 (r.isWaiting || e.dispatch(Ot({ reason: r.reason })));
 };
 const tn = s.compose;
 var nn = ({
 dimensionMarshal: e,
 ...
 "DROP_ANIMATE" === t.type &&
 a.dropping(t.payload.completed.result.reason),
 ...
 const n =
 pn(t).find(
 (t) => (t.frame || M(!1), Je(t.frame.pageMarginBox)(e)),
 ) || null;
 return n;
 })(e, n);
 return r;
 ...
 Dn = (e, t) =>
 In({ current: e.scroll.current, max: e.scroll.max, change: t }),
 En = (e, t) => {
 const n = e.frame;
 return (
 !!n &&
 ...
 if (!Ar({ lockAPI: e, store: n, registry: r, draggableId: i }))
 return null;
 ...
 Sr({ expected: e, phase: d, isLockActive: p, shouldWarn: !0 }) &&
 n.dispatch(t());
 }.bind(null, "DRAGGING");
 function g(t) {
 function r() {
 ...
 const e = i();
 "PENDING" === e.type &&
 (clearTimeout(e.longPressTimerId), o(hr));
 }
 );
 },
 [i, s, o],
 ...
 const c = u(
 (e) => Ar({ lockAPI: s, registry: n, store: t, draggableId: e }),
 [s, n, t],
 ),
 p = u(
 (r, i, o) =>
 ...
 return d(
 () => ({ dragging: l, dropping: c, resting: p }),
 [l, c, p],
 );
 })(t, a),
 y = u((e) => {
 ...
 f = d(
 () => ({ uniqueId: t, descriptor: n, options: c, getDimension: p }),
 [n, p, c, t],
 ),
 g = (0, r.useRef)(f),
 h = (0, r.useRef)(!0);
 ...
 () => i.draggable.unregister(g.current)
 ),
 [i.draggable],
 ),
 Mn(() => {
 ...
 s = a.mode,
 l = Yr(a),
 c = ((e) => (e.combine ? e.combine.draggableId : null))(
 a,
 ),
 d = {
 ...
 if (!e) return !1;
 return (
 "fixed" === window.getComputedStyle(e).position || ci(e.parentElement)
 );
 };
 var di = ({
 ref: e,
 ...
 I = d(
 () => ({ uniqueId: i, descriptor: l, callbacks: w }),
 [w, l, i],
 );
 (Mn(
 () => (
 ...
 P = d(
 () => ({ droppableId: p, type: f, isUsingCloneFor: O }),
 [p, O, f],
 );
 return i().createElement(
 Hr.Provider,
 ...
 function () {
 return s(
 s({ position: "absolute", userSelect: "none" }, u[n]),
 null != a ? a : {},
 );
 },
 [a, n],
 ...
 v("right", l) &&
 ((g = c.width + ((e - c.x) * o) / r),
 u && (h = (g - b) / this.ratio + m)),
 v("left", l) &&
 ((g = c.width - ((e - c.x) * o) / r),
 u && (h = (g - b) / this.ratio + m)),
 v("bottom", l) &&
 ((h = c.height + ((t - c.y) * a) / r),
 u && (g = (h - m) * this.ratio + b)),
 v("top", l) &&
 ((h = c.height - ((t - c.y) * a) / r),
 u && (g = (h - m) * this.ratio + b)),
 ...
 ((this.parentLeft = n.left * e),
 (this.parentTop = n.top * e));
 }
 }
 ...
 this.props.onResize &&
 G &&
 this.props.onResize(e, u, this.resizable, O));
 }
 }),
 ...
 this.setState({
 width:
 null !== (t = this.props.size.width) && void 0 !== t
 ? t
 : "auto",
 height:
 null !== (n = this.props.size.height) && void 0 !== n
 ? n
 : "auto",
 }),
 this.unbindEvents(),
 ...
 r.findPane(e, t) ||
 (r.panes[t].length > 0 &&
 r.syncScrollPosition(r.panes[t][0], e),
 r.panes[t].push(e)));
 }),
 r.addEvents(e, t));
 }),
 ...
 r.findPane(e, t) &&
 (r.removeEvents(e),
 r.panes[t].splice(r.panes[t].indexOf(e), 1));
 });
 }),
 ...
 (this.updateNode(),
 this.node &&
 this.context.registerPane(
 this.node,
 this.toArray(this.props.group),
 ));
 },
 },
 {
 ...
 (this.node &&
 this.context.unregisterPane(
 this.node,
 this.toArray(e.group),
 ),
 this.updateNode(),
 this.node &&
 this.context.registerPane(
