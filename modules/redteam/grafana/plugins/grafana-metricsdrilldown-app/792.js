...
(self.webpackChunkgrafana_metricsdrilldown_app =
 ...
 let o = r.trim();
 (Number.isNaN(Number(r)) || (o = Number(r)),
 ...
 function c(e, t, n) {
 const r = [...e]
 .map((e, r) => u(e, { ...n, index: r, level: t + 1 }))
 .filter(Boolean);
 ...
 ((a = t.pre(a, c, o)), a instanceof Node || (a = e)),
 ...
 try {
 const t = l(
 E({ ...e, handleError: I, hash: R.current, content: A }),
 );
