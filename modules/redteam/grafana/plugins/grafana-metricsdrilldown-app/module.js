...
define([
 ...
 "use strict";
 i.d(t, { q: () => r });
 const n = new RegExp("([a-zA-Z_]\\w*)(>|<|!~|=~|!=|=)(.+)");
 function r(e) {
 const [, t, i, r] = e.match(n) || [, "", "", ""];
 return {
 key: t.trim(),
 value: r.replace(/['" ]/g, ""),
 operator: i.trim(),
 ...
 var n = i(7203);
 class r {
 constructor(e, t, i, n, r, s, o, a, l, u = 0, c) {
 ((this.p = e),
 (this.stack = t),
 (this.state = i),
 (this.reducePos = n),
 ...
 return (
 t >= this.token.lookAhead && (this.token.lookAhead = t + 1),
 i
 );
 }
 acceptToken(e, t = 0) {
 ...
 h.prototype.contextual =
 h.prototype.fallback =
 h.prototype.extend =
 !1;
 ...
 function p(e, t, i) {
 for (let n, r = t; 65535 != (n = e[r]); r++)
 if (n == i) return r - t;
 return -1;
 }
 function g(e, t, i, n) {
 let r = p(i, n, t);
 return r < 0 || p(i, n, e) < r;
 }
 const m =
 ...
 let v = null;
 function b(e, t, i) {
 let r = e.cursor(n.Qj.IncludeAnonymous);
 for (r.moveTo(t); ; )
 ...
 ? b(e.tree, e.from + e.offset, 1) - e.offset
 : e.from,
 this.safeTo = e.openEnd
 ? b(e.tree, e.to + e.offset, -1) - e.offset
 : e.to;
 this.trees.length;
 ...
 if (s instanceof n.PH) {
 if (o == e) {
 if (o < this.safeFrom) return null;
 let e = o + s.length;
 if (e <= this.safeTo) {
 let t = s.prop(n.uY.lookAhead);
 ...
 0 == n &&
 2 == o[a + 1] &&
 (n = this.putAction(S(o, a + 2), t, i, n));
 break;
 }
 a = S(o, a + 2);
 }
 o[a] == t && (n = this.putAction(S(o, a + 1), t, i, n));
 }
 return n;
 }
 }
 ...
 (this.stream = new d(t, n)),
 (this.tokens = new w(e, this.stream)),
 (this.topTerm = e.top[1]));
 let { from: s } = n[0];
 ((this.stacks = [r.start(this, e.top[0], s)]),
 (this.fragments =
 ...
 throw new SyntaxError("No parse at " + n);
 ...
 !(
 (t.score - n.score ||
 t.buffer.length - n.buffer.length) > 0
 )
 ) {
 r.splice(e--, 1);
 continue e;
 ...
 r > -1 &&
 o.length &&
 (!t || (o.prop(n.uY.contextHash) || 0) == i)
 )
 return (e.useNode(o, r), !0);
 if (
 !(o instanceof n.PH) ||
 0 == o.children.length ||
 o.positions[0] > 0
 ...
 break;
 let a = o.children[0];
 if (!(a instanceof n.PH && 0 == o.positions[0])) break;
 o = a;
 }
 }
 ...
 if ((c.apply(s, o, d ? d.start : c.pos, l), u)) return !0;
 c.pos > r ? t.push(c) : i.push(c);
 }
 return !1;
 }
 advanceFully(e, t) {
 ...
 if (o.deadEnd) {
 if (r) continue;
 if (((r = !0), o.restart(), this.advanceFully(o, i)))
 continue;
 }
 let c = o.split(),
 d = u;
 ...
 return (
 t || v.set(e, (t = String.fromCodePoint(this.nextStackID++))),
 t + e
 );
 }
 }
 ...
 function s(e, t, i) {
 r[e].push([t, t.deserialize(String(i))]);
 }
 if (e.nodeProps)
 for (let t of e.nodeProps) {
 let e = t[0];
 "string" == typeof e && (e = n.uY[e]);
 for (let i = 1; i < t.length; ) {
 let n = t[i++];
 if (n >= 0) s(n, e, t[i++]);
 else {
 let r = t[i + -n];
 for (let o = -n; o > 0; o--) s(t[i++], e, r);
 i++;
 }
 }
 }
 ((this.nodeSet = new n.fI(
 t.map((t, s) =>
 n.Z6.define({
 ...
 if (65535 == (r = i[s])) {
 if (1 != i[s + 1]) {
 if (2 == i[s + 1]) return S(i, s + 2);
 break;
 }
 r = i[(s = S(i, s + 2))];
 }
 if (r == t || 0 == r) return S(i, s + 1);
 }
 return 0;
 }
 stateSlot(e, t) {
 ...
 configure(e) {
 let t = Object.assign(Object.create(k.prototype), this);
 if (
 (e.props && (t.nodeSet = this.nodeSet.extend(...e.props)),
 e.top)
 ) {
 ...
 for (let n = i; 0 !== n--; ) if (!S(e[n], t[n])) return !1;
 return !0;
 }
 const r = f(e),
 s = f(t);
 ...
 for (let n of i) if (!S(e[n], t[n])) return !1;
 return !0;
 }
 return !1;
 }
 const P = "user-action-start",
 T = "user-action-end",
 E = "user-action-cancel",
 z = "user-action-halt";
 const Q = "Error",
 A = (e) => e.map((e) => (f(e) ? w(e) : String(e))).join(" ");
 let C;
 function I({
 internalLogger: e,
 config: t,
 ...
 let d = null;
 C = null !== (l = t.parseStacktrace) && void 0 !== l ? l : C;
 const h = (t) => {
 (e.debug("Changing stacktrace parser"),
 (C = null != t ? t : C));
 },
 { ignoreErrors: p = [], preserveOriginalError: m } = t;
 return (
 h(t.parseStacktrace),
 {
 ...
 context: T,
 spanContext: E,
 timestampOverwriteMs: z,
 originalError: A,
 } = {},
 ) => {
 if (
 !(function (e, t) {
 const { message: i, name: n, stack: r } = t;
 return (
 (s = e),
 (o = i + " " + n + " " + r),
 s.some((e) => (c(e) ? o.includes(e) : !!o.match(e)))
 );
 var s, o;
 })(p, null != A ? A : l)
 )
 ...
 : void 0)
 ? void 0
 : v.length) && (p.payload.stacktrace = { frames: v });
 const I = {
 type: p.payload.type,
 ...
 if (!h && t.dedupe && !u(d) && S(I, d))
 return void e.debug(
 "Skipping error push because it is the same as the last one\n",
 p.payload,
 );
 ((d = I), e.debug("Pushing exception\n", p));
 const X = a();
 X && X.type === P ? o.addItem(p) : n.execute(p);
 } catch (t) {
 ...
 flushBuffer(e) {
 if (p(e)) for (const t of this.buffer) e(t);
 ...
 function R({ apiMessageBus: e, transports: t, config: i }) {
 const n = new _(),
 s = i.trackUserActionsExcludeItem;
 let o;
 e.subscribe((e) => {
 if (P !== e.type && z !== e.type) {
 if (e.type === T) {
 const { id: i, name: a } = e;
 return (
 n.flushBuffer((e) => {
 ...
 return (
 (null == t ? void 0 : t(e)) ||
 (e.type === r.MEASUREMENT &&
 "web-vitals" === e.payload.type)
 );
 })(e, s)
 )
 return void t.execute(e);
 ...
 return { actionBuffer: n, getMessage: () => o };
 }
 const L = new n();
 function N(e, t, i, n, s) {
 t.debug("Initializing API");
 const { actionBuffer: o, getMessage: a } = R({
 apiMessageBus: L,
 transports: s,
 config: i,
 }),
 ...
 null == o
 ? void 0
 : o.trace.getSpanContext(o.context.active());
 return e
 ? { trace_id: e.traceId, span_id: e.spanId }
 : void 0;
 },
 ...
 Object.assign(
 Object.assign(
 Object.assign(Object.assign({}, l), I(d)),
 ...
 a = (e, n) => {
 var r;
 const s = null == n ? void 0 : n.overrides,
 o = s
 ? {
 ...
 let c = null;
 const d =
 null !== (l = t.logArgsSerializer) && void 0 !== l
 ? l
 : U;
 return {
 pushLog: (
 ...
 if (!p && t.dedupe && !u(c) && S(w, c))
 return void e.debug(
 "Skipping log push because it is the same as the last one\n",
 b.payload,
 );
 ((c = w), e.debug("Pushing log\n", b));
 const $ = a();
 $ && $.type === P ? o.addItem(b) : n.execute(b);
 } catch (t) {
 ...
 m = {
 type: r.MEASUREMENT,
 payload: Object.assign(Object.assign({}, c), {
 trace: f
 ? { trace_id: f.traceId, span_id: f.spanId }
 : s.getTraceContext(),
 timestamp: p ? k(p) : x(),
 context: O(g) ? void 0 : g,
 }),
 meta: i.value,
 },
 v = {
 ...
 if (!d && t.dedupe && !u(l) && S(v, l))
 return void e.debug(
 "Skipping measurement push because it is the same as the last one\n",
 m.payload,
 );
 ((l = v), e.debug("Pushing measurement\n", m));
 const b = a();
 b && b.type === P ? o.addItem(m) : n.execute(m);
 } catch (t) {
 ...
 const M = { debug: D, error: D, info: D, prefix: "Faro", warn: D },
 q = j.ERROR,
 F = Object.assign({}, console);
 function B(e = F, t = q) {
 const i = M;
 return (
 t > j.OFF &&
 ...
 let V = M;
 function W(e, t) {
 return ((V = B(e, t.internalLoggerLevel)), V);
 }
 const Y =
 ...
 : void 0;
 const Z = "1.19.0";
 const H = "_faroInternal";
 let G = {};
 function K(e, t, i, n, r, s, o) {
 return (
 ...
 Object.defineProperty(Y, e.config.globalObjectKey, {
 configurable: !1,
 writable: !1,
 value: e,
 });
 ...
 ((this.signalBuffer = []),
 (this.itemLimit =
 null !== (i = null == t ? void 0 : t.itemLimit) &&
 void 0 !== i
 ? i
 : 50),
 (this.sendTimeout =
 null !== (n = null == t ? void 0 : t.sendTimeout) &&
 void 0 !== n
 ? n
 : 250),
 ...
 let t = e;
 for (const e of a) {
 const n = t.map(e).filter(Boolean);
 ...
 for (const t of e)
 t.type === r.EXCEPTION && delete t.payload.originalError;
 return e;
 }
 let ie = F;
 function ne(e) {
 var t;
 return (
 (ie = null !== (t = e.unpatchedConsole) && void 0 !== t ? t : ie),
 ie
 );
 }
 function re(e) {
 ...
 n = [];
 const r = () =>
 i.reduce((e, t) => Object.assign(e, p(t) ? t() : t), {}),
 s = () => {
 if (n.length) {
 const e = r();
 n.forEach((t) => t(e));
 ...
 ? t.warn(
 `Instrumentation ${a.name} is already added`,
 )
 ...
 const r = o.reduce(
 (t, i, n) =>
 null === t && i.name === e.name ? n : null,
 null,
 );
 null !== r
 ? (null === (n = (i = o[r]).destroy) ||
 void 0 === n ||
 n.call(i),
 o.splice(r, 1))
 ...
 e.config.app.name &&
 ((r = e.config.app.name),
 null == Y ? void 0 : Y[`__faroBundleId_${r}`]),
 },
 };
 var r;
 const s =
 ...
 const se = "faro",
 oe = { enabled: !0, sendTimeout: 250, itemLimit: 50 },
 ae = "browser",
 le = "\n",
 ue = "eval",
 ce = "?",
 ...
 function ke(e, t) {
 const i = null == e ? void 0 : e.includes(we),
 n = !i && (null == e ? void 0 : e.includes(ye));
 return i || n
 ? [
 (null == e ? void 0 : e.includes(de)) ? e.split(de)[0] : e,
 i ? `${we}:${t}` : `${ye}:${t}`,
 ]
 : [e, t];
 }
 ...
 let t = [];
 e.stacktrace
 ? (t = e.stacktrace.split(le).filter((e, t) => t % 2 == 0))
 : e.stack && (t = e.stack.split(le));
 ...
 (a = r[3]),
 (l = r[4]),
 null == o ? void 0 : o.startsWith(pe))
 ) {
 const e = fe.exec(o);
 e && ((o = e[1]), (a = e[2]), (l = e[3]));
 }
 ((o = (null == o ? void 0 : o.startsWith(ge))
 ? o.substring(me)
 : o),
 ([s, o] = ke(s, o)));
 } else if ((r = ve.exec(i))) {
 ...
 (o || s) &&
 t.push(
 xe(o, s, a ? Number(a) : void 0, l ? Number(l) : void 0),
 ),
 t
 );
 }, []);
 return $e.test(e.message) ? i.slice(1) : i;
 }
 function Pe(e) {
 return { frames: Se(e) };
 }
 const Te = "com.grafana.faro.session",
 Ee = 9e5,
 ze = { enabled: !0, persistent: !1, maxSessionPersistenceTime: Ee },
 Qe = "http-request-start",
 Ae = "http-request-end",
 Ce = "data-faro-user-action-name",
 Ie = "faroApiCall";
 var Xe = i(6660);
 const Ue = "unknown",
 _e = () => {
 const e = new Xe.UAParser(),
 { name: t, version: i } = e.getBrowser(),
 { name: n, version: r } = e.getOS(),
 s = e.getUA(),
 ...
 name: null != t ? t : Ue,
 version: null != i ? i : Ue,
 os: `${null != n ? n : Ue} ${null != r ? r : Ue}`,
 userAgent: null != s ? s : Ue,
 language: null != o ? o : Ue,
 mobile: a,
 brands: null != l ? l : Ue,
 ...
 let Le, Ne;
 function De({ generatePageId: e, initialPageMeta: t } = {}) {
 return () => {
 const i = location.href;
 return (
 p(e) && Le !== i && ((Le = i), (Ne = e(location))),
 {
 page: Object.assign(
 Object.assign({ url: i }, Ne ? { id: Ne } : {}),
 t,
 ),
 }
 );
 ...
 class je {
 constructor() {
 ((this.unpatchedConsole = F),
 (this.internalLogger = M),
 (this.config = {}),
 (this.metas = {}));
 }
 logDebug(...e) {
 ...
 const r =
 null === (i = e.resourceSpans) || void 0 === i ? void 0 : i[0];
 if (void 0 === r) return e;
 const s = (null == r ? void 0 : r.scopeSpans) || [],
 o =
 ...
 n = !1;
 const r = () => {
 null != i ? (e(...i), (i = null), setTimeout(r, t)) : (n = !1);
 };
 return (...s) => {
 n ? (i = s) : (e(...s), (n = !0), setTimeout(r, t));
 };
 }
 const Be = "sessionStorage",
 Ve = "localStorage";
 function We(e) {
 var t;
 try {
 ...
 return (
 null === (t = G.internalLogger) ||
 void 0 === t ||
 t.info(
 `Web storage of type ${e} is not available. Reason: ${i}`,
 ),
 !1
 );
 }
 ...
 Ke = We(Be);
 function Je(e) {
 return e === Ve ? Ge : e === Be && Ke;
 }
 const et =
 "abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ0123456789";
 function tt(e = 10) {
 return Array.from(Array(e))
 .map(() => et[Math.floor(59 * Math.random())])
 .join("");
 }
 const it = "session_start",
 nt = "session_resume",
 rt = "service_name_override";
 function st() {
 var e, t, i;
 const n = G.config.sessionTracking;
 let r =
 null !==
 (i =
 null !==
 (t =
 null === (e = null == n ? void 0 : n.sampler) ||
 void 0 === e
 ? void 0
 : e.call(n, { metas: G.metas.value })) && void 0 !== t
 ? t
 : null == n
 ? void 0
 : n.samplingRate) && void 0 !== i
 ? i
 : 1;
 if ("number" != typeof r) {
 r = 0;
 ...
 null ===
 (s =
 null === (r = G.config) || void 0 === r
 ? void 0
 : r.sessionTracking) || void 0 === s
 ? void 0
 : s.generateSessionId;
 return (
 null == e && (e = "function" == typeof a ? a() : tt()),
 {
 sessionId: e,
 ...
 return t - e.lastActivity < Ee;
 }
 function lt({ fetchUserSession: e, storeUserSession: t }) {
 return function (
 { forceSessionExtend: i } = { forceSessionExtend: !1 },
 ) {
 var n, r, s;
 if (!e || !t) return;
 const o = G.config.sessionTracking,
 a = null == o ? void 0 : o.persistent;
 if ((a && !Ge) || (!a && !Ke)) return;
 const l = e();
 if (!1 === i && at(l))
 t(Object.assign(Object.assign({}, l), { lastActivity: $() }));
 else {
 let e = ut(ot({ isSampled: st() }), l);
 (t(e),
 null === (n = G.api) ||
 void 0 === n ||
 n.setSession(e.sessionMeta),
 null === (r = null == o ? void 0 : o.onSessionChange) ||
 void 0 === r ||
 r.call(
 o,
 null !== (s = null == l ? void 0 : l.sessionMeta) &&
 void 0 !== s
 ? s
 : null,
 e.sessionMeta,
 ...
 null ===
 (n =
 null === (i = G.config.sessionTracking) ||
 void 0 === i
 ? void 0
 : i.session) || void 0 === n
 ? void 0
 ...
 null !==
 (s =
 null === (r = G.metas.value.session) || void 0 === r
 ? void 0
 ...
 null !==
 (a =
 null === (o = G.metas.value.session) || void 0 === o
 ? void 0
 : o.overrides) && void 0 !== a
 ? a
 : null === (l = null == t ? void 0 : t.sessionMeta) ||
 void 0 === l
 ? void 0
 : l.overrides;
 O(c) || (u.sessionMeta.overrides = c);
 const d = null == t ? void 0 : t.sessionId;
 return (
 null != d && (u.sessionMeta.attributes.previousSession = d),
 u
 );
 }
 function ct({ fetchUserSession: e, storeUserSession: t }) {
 return function (i) {
 const n = i.session,
 r = e();
 let s = null == n ? void 0 : n.id;
 const o = null == n ? void 0 : n.attributes,
 a = null == n ? void 0 : n.overrides,
 l = null == r ? void 0 : r.sessionMeta,
 u = null == l ? void 0 : l.overrides,
 c = !!a && !S(a, u),
 d = !!o && !S(o, null == l ? void 0 : l.attributes);
 if ((!!n && s !== (null == r ? void 0 : r.sessionId)) || d || c) {
 const e = ut(ot({ sessionId: s, isSampled: st() }), r);
 (t(e),
 (function (e, t = {}, i = {}) {
 var n, r, s;
 if (!e) return;
 ...
 null !==
 (s =
 null !== (n = i.serviceName) && void 0 !== n
 ? n
 : null === (r = G.metas.value.app) || void 0 === r
 ? void 0
 : r.name) && void 0 !== s
 ? s
 : "";
 ...
 G.api.pushEvent(rt, {
 serviceName: o,
 previousServiceName: a,
 });
 })(c, a, u),
 G.api.setSession(e.sessionMeta));
 }
 };
 }
 class dt {
 constructor() {
 ((this.updateSession = Fe(() => this.updateUserSession(), 1e3)),
 (this.updateUserSession = lt({
 fetchUserSession: dt.fetchUserSession,
 storeUserSession: dt.storeUserSession,
 })),
 this.init());
 }
 static removeUserSession() {
 He(Te, dt.storageTypeLocal);
 }
 static storeUserSession(e) {
 Ze(Te, w(e), dt.storageTypeLocal);
 }
 static fetchUserSession() {
 const e = Ye(Te, dt.storageTypeLocal);
 ...
 dt.storageTypeLocal = Ve;
 class ht {
 constructor() {
 ((this.updateSession = Fe(() => this.updateUserSession(), 1e3)),
 (this.updateUserSession = lt({
 fetchUserSession: ht.fetchUserSession,
 storeUserSession: ht.storeUserSession,
 })),
 this.init());
 }
 static removeUserSession() {
 He(Te, ht.storageTypeSession);
 }
 static storeUserSession(e) {
 Ze(Te, w(e), ht.storageTypeSession);
 }
 static fetchUserSession() {
 const e = Ye(Te, ht.storageTypeSession);
 return e ? JSON.parse(e) : null;
 }
 init() {
 (document.addEventListener("visibilitychange", () => {
 ...
 function ft(e) {
 return (null == e ? void 0 : e.persistent) ? dt : ht;
 }
 ht.storageTypeSession = Be;
 ...
 null !== (t = e.defaultRateLimitBackoffMs) && void 0 !== t
 ? t
 : 5e3),
 (this.getNow =
 null !== (i = e.getNow) && void 0 !== i
 ? i
 : () => Date.now()),
 ...
 (n.push({ producer: e, resolve: t, reject: i }), s());
 });
 },
 };
 })({
 ...
 concurrency:
 null !== (r = e.concurrency) && void 0 !== r ? r : 5,
 })));
 }
 send(e) {
 ...
 { url: i, requestOptions: n, apiKey: o } = this.options,
 a = null != n ? n : {},
 { headers: l } = a,
 u = gt(a, ["headers"]);
 let c;
 const d = this.metas.value.session;
 return (
 null != d && (c = d.id),
 fetch(
 i,
 ...
 if (202 === e.status) {
 "invalid" ===
 e.headers.get("X-Faro-Session-Status") &&
 this.extendFaroSession(
 this.config,
 this.logDebug,
 );
 }
 ...
 const { fetchUserSession: e, storeUserSession: r } = ft(n);
 (lt({ fetchUserSession: e, storeUserSession: r })({
 ...
 function bt(e = "") {
 return G.transports.transports
 ...
 const e = new n();
 function t(t) {
 e.notify({ type: Qe, request: t });
 }
 function i(t) {
 e.notify({ type: Ae, request: t });
 }
 return (
 ...
 : o instanceof URL
 ? o.href
 : !O(o) && p(null == o ? void 0 : o.toString)
 ? o.toString()
 : void 0) && void 0 !== n
 ? n
 : "";
 var o;
 const a = bt(s),
 l = (null !== (r = arguments[1]) && void 0 !== r ? r : {})
 .method,
 u = tt();
 return (
 a || t({ url: s, method: l, requestId: u, apiType: Ot }),
 i
 .apply(this, arguments)
 .then(
 (t) => (
 a ||
 e({ url: s, method: l, requestId: u, apiType: Ot }),
 t
 ),
 )
 .catch((t) => {
 ...
 })({ onRequestStart: t, onRequestEnd: i }),
 ...
 r || e({ url: n, method: s, requestId: o, apiType: wt });
 }),
 this.addEventListener("load", function () {
 r || t({ url: n, method: s, requestId: o, apiType: wt });
 }),
 ...
 const $t = "com.grafana.faro.lastNavigationId",
 xt = "resource",
 kt = /^00-[a-f0-9]{32}-[a-f0-9]{16}-[0-9]{1,2}$/;
 function St(e = []) {
 for (const t of e)
 if ("traceparent" === t.name) {
 if (!kt.test(t.description)) continue;
 ...
 const t = e[i];
 return null != t && (g(n) ? n.includes(t) : t === n);
 }
 return !0;
 }
 function Tt(e) {
 ...
 name: c,
 duration: zt(o),
 tcpHandshakeTime: zt(t - i),
 dnsLookupTime: zt(r - s),
 tlsNegotiationTime: zt(t - O),
 responseStatus: zt(b),
 redirectTime: zt(h - f),
 requestTime: zt(v - g),
 responseTime: zt(m - v),
 fetchTime: zt(m - l),
 serviceWorkerTime: zt(l - y),
 decodedBodySize: zt(n),
 encodedBodySize: zt(a),
 ...
 return Object.assign(Object.assign({}, Tt(e)), {
 pageLoadTime: zt(i - o),
 documentParsingTime: zt(d ? s - d : null),
 domProcessingTime: zt(i - s),
 domContentLoadHandlerTime: zt(n - r),
 onLoadTime: zt(a - l),
 ttfb: zt(Math.max(u - (null != t ? t : 0), 0)),
 type: c,
 });
 }
 function zt(e) {
 ...
 const Qt = { initiatorType: ["xmlhttprequest", "fetch"] };
 ...
 if (null == r || bt(r.name)) return;
 const s = r.toJSON();
 let o = St(null == s ? void 0 : s.serverTiming);
 const a =
 null !== (n = Ye($t, Be)) && void 0 !== n
 ? n
 : Ue,
 l = Object.assign(Object.assign({}, Et(s)), {
 faroNavigationId: tt(),
 faroPreviousNavigationId: a,
 });
 (Ze($t, l.faroNavigationId, Be),
 ...
 null != t &&
 (function (e, t, i) {
 const n = G.config.trackResources;
 new PerformanceObserver((r) => {
 const s = r.getEntries();
 for (const r of s) {
 if (bt(r.name)) return;
 const s = r.toJSON();
 let o = St(null == s ? void 0 : s.serverTiming);
 ...
 Object.assign({}, Tt(s)),
 { faroNavigationId: e, faroResourceId: tt() },
 );
 (G.config.trackUserActionsPreview &&
 (null == i || i.notify({ type: xt })),
 t("faro.performance.resource", n, void 0, {
 spanContext: o,
 timestampOverwriteMs:
 performance.timeOrigin + s.startTime,
 }));
 ...
 return (
 Ct.subscribe((t) => {
 t.type === xt && e.notify({ type: "resource-entry" });
 }),
 e
 );
 })();
 ...
 var u;
 let c;
 const d = (h = e).type === Ie && "string" == typeof h.name;
 var h;
 if (
 ((c = d
 ? e.name
 ...
 e.target,
 null !== (u = i.trackUserActionsDataAttributeName) &&
 void 0 !== u
 ? u
 : "faroUserActionName",
 )),
 ...
 let p;
 const g = tt();
 (L.notify({ type: P, name: c, startTime: f, parentId: g }),
 (a = _t(
 a,
 () => {
 ((p = $()),
 (l = !1),
 (function (e, t) {
 L.notify({ type: E, name: e, parentId: t });
 })(c, g));
 },
 100,
 )));
 ...
 .merge(r, s, o)
 .takeWhile(() => l)
 .filter((e) => !!(!b || (Lt(e) && m.has(e.request.requestId))))
 .subscribe((i) => {
 ((function (e) {
 return e.type === Qe;
 })(i) && m.set(i.request.requestId, i.request),
 Lt(i) && m.delete(i.request.requestId),
 (a = _t(
 a,
 () => {
 p = $();
 ...
 Object.assign(
 {
 userActionStartTime: n.toString(),
 userActionEndTime: r.toString(),
 userActionDuration: l.toString(),
 userActionTrigger: u,
 },
 y(a),
 ),
 void 0,
 {
 timestampOverwriteMs: n,
 customPayloadTransformer: (e) => (
 (e.action = { id: s, name: i }),
 e
 ),
 },
 ));
 ...
 r,
 s = [];
 if (((e) => a(e, "ErrorEvent"))(e) && e.error)
 ((t = e.error.message), (i = e.error.name), (s = Se(e.error)));
 else if (
 (n = ((e) => a(e, "DOMError"))(e)) ||
 ((e) => a(e, "DOMException"))(e)
 ) {
 const { name: r, message: s } = e;
 ((i = null != r ? r : n ? "DOMError" : "DOMException"),
 (t = s ? `${i}: ${s}` : i));
 } else
 b(e)
 ? ((t = e.message), (s = Se(e)))
 : (f(e) || (r = ((e) => m && l(e, Event))(e))) &&
 ((i = r ? e.constructor.name : void 0),
 ...
 : Q;
 return [
 null !== (i = null == n ? void 0 : n[2]) && void 0 !== i
 ? i
 : e,
 r,
 ];
 ...
 let a = [];
 (((e) => !f(e) && !p(e))(o)
 ? ((r = `Non-Error promise rejection captured with value: ${String(o)}`),
 (s = "UnhandledRejection"))
 : ([r, s, a] = Mt(o)),
 r && e.pushError(new Error(r), { type: s, stackFrames: a }));
 });
 }
 class Vt extends vt {
 constructor() {
 ...
 window.onerror = (...i) => {
 try {
 const { value: t, type: n, stackFrames: r } = qt(i),
 s = i[4];
 if (t) {
 const i = { type: n, stackFrames: r };
 (null != s && (i.originalError = s),
 ...
 "pageshow",
 function (t) {
 t.persisted && ((Kt = t.timeStamp), e(t));
 },
 !0,
 );
 },
 ...
 return (
 n.observe(
 Object.assign({ type: e, buffered: !0 }, i || {}),
 ),
 n
 );
 }
 ...
 li > -1 &&
 ((li = "visibilitychange" === e.type ? e.timeStamp : 0), hi());
 },
 di = function () {
 (addEventListener("visibilitychange", ci, !0),
 addEventListener("prerenderingchange", ci, !0));
 },
 hi = function () {
 (removeEventListener("visibilitychange", ci, !0),
 removeEventListener("prerenderingchange", ci, !0));
 },
 fi = function () {
 return (
 li < 0 &&
 ...
 n = fi(),
 r = ii("FCP"),
 s = ni("paint", function (e) {
 e.forEach(function (e) {
 "first-contentful-paint" === e.name &&
 (s.disconnect(),
 e.startTime < n.firstHiddenTime &&
 ((r.value = Math.max(e.startTime - ti(), 0)),
 r.entries.push(e),
 i(!0)));
 });
 });
 s &&
 ((i = ri(e, r, gi, t.reportAllChanges)),
 Jt(function (n) {
 ((r = ii("FCP")),
 (i = ri(e, r, gi, t.reportAllChanges)),
 si(function () {
 ...
 e.forEach(function (e) {
 e.interactionId &&
 ((Oi = Math.min(Oi, e.interactionId)),
 (wi = Math.max(wi, e.interactionId)),
 (bi = wi ? (wi - Oi) / 7 + 1 : 0));
 });
 },
 $i = function () {
 return Wt ? bi : performance.interactionCount || 0;
 },
 xi = function () {
 ...
 var t = ki[ki.length - 1],
 i = Si.get(e.interactionId);
 if (i || ki.length < 10 || e.duration > t.latency) {
 if (i)
 ...
 (Si.set(n.id, n), ki.push(n));
 }
 (ki.sort(function (e, t) {
 return t.latency - e.latency;
 }),
 ki.length > 10 &&
 ki.splice(10).forEach(function (e) {
 return Si.delete(e.id);
 }));
 }
 }
 },
 ...
 processingStart: Yt.timeStamp + Zt,
 };
 ...
 r = function () {
 (removeEventListener("pointerup", i, Ui),
 removeEventListener("pointercancel", n, Ui));
 };
 (addEventListener("pointerup", i, Ui),
 addEventListener("pointercancel", n, Ui));
 })(t, e)
 : Ri(t, e);
 }
 },
 ...
 initialize() {
 Object.entries(Mi.mapping).forEach(([e, t]) => {
 var i;
 t(
 (t) => {
 ...
 {
 reportAllChanges:
 null === (i = this.webVitalConfig) || void 0 === i
 ? void 0
 : i.reportAllChanges,
 },
 );
 ...
 r > n.value && ((n.value = r), (n.entries = s), i()));
 },
 a = ni("layout-shift", o);
 a &&
 ((i = ri(e, n, vi, t.reportAllChanges)),
 oi(function () {
 (o(a.takeRecords()), i(!0));
 }),
 Jt(function () {
 ...
 a = ni("first-input", o);
 ((i = ri(e, r, ji, t.reportAllChanges)),
 a &&
 (oi(
 ai(function () {
 ...
 o = ni("event", s, {
 durationThreshold:
 null !== (i = t.durationThreshold) && void 0 !== i
 ? i
 : 40,
 });
 ((n = ri(e, r, Qi, t.reportAllChanges)),
 o &&
 ...
 o = ni("largest-contentful-paint", s);
 if (o) {
 i = ri(e, r, Ai, t.reportAllChanges);
 var a = ai(function () {
 Ci[r.id] ||
 (s(o.takeRecords()),
 o.disconnect(),
 ...
 t = t || {};
 var i = ii("TTFB"),
 n = ri(e, i, Ii, t.reportAllChanges);
 Xi(function () {
 var r = ei();
 r &&
 ((i.value = Math.max(r.responseStart - ti(), 0)),
 (i.entries = [r]),
 n(!0),
 Jt(function () {
 ((i = ii("TTFB", 0)),
 (n = ri(e, i, Ii, t.reportAllChanges))(!0));
 }));
 });
 },
 };
 ...
 "pageshow",
 function (t) {
 t.persisted && ((Zi = t.timeStamp), e(t));
 },
 !0,
 );
 },
 ...
 "hidden" === document.visibilityState &&
 on > -1 &&
 ((on = "visibilitychange" === e.type ? e.timeStamp : 0), cn());
 },
 un = function () {
 ...
 n = dn(),
 r = Ji("FCP"),
 s = en("paint", function (e) {
 e.forEach(function (e) {
 "first-contentful-paint" === e.name &&
 (s.disconnect(),
 e.startTime < n.firstHiddenTime &&
 ((r.value = Math.max(e.startTime - Ki(), 0)),
 r.entries.push(e),
 i(!0)));
 });
 });
 s &&
 ((i = tn(e, r, fn, t.reportAllChanges)),
 Gi(function (n) {
 ((r = Ji("FCP")),
 (i = tn(e, r, fn, t.reportAllChanges)),
 nn(function () {
 ...
 e.forEach(function (e) {
 e.interactionId &&
 ((vn = Math.min(vn, e.interactionId)),
 (bn = Math.max(bn, e.interactionId)),
 (mn = bn ? (bn - vn) / 7 + 1 : 0));
 });
 },
 wn = function () {
 return qi ? mn : performance.interactionCount || 0;
 },
 yn = [],
 $n = new Map(),
 xn = 0,
 ...
 var t = yn[yn.length - 1],
 i = $n.get(e.interactionId);
 if (i || yn.length < 10 || e.duration > t.latency) {
 if (i)
 e.duration > i.latency
 ? ((i.entries = [e]), (i.latency = e.duration))
 : e.duration === i.latency &&
 ...
 ($n.set(n.id, n), yn.push(n));
 }
 (yn.sort(function (e, t) {
 return t.latency - e.latency;
 }),
 yn.length > 10 &&
 yn.splice(10).forEach(function (e) {
 ...
 ((n = tn(e, r, Tn, t.reportAllChanges)),
 o &&
 (o.observe({ type: "first-input", buffered: !0 }),
 rn(function () {
 (s(o.takeRecords()), n(!0));
 ...
 Rn = function () {
 In.size > 10 &&
 In.forEach(function (e, t) {
 $n.has(t) || In.delete(t);
 });
 var e = yn.map(function (e) {
 return Cn.get(e.entries[0]);
 }),
 t = Qn.length - 50;
 Qn = Qn.filter(function (i, n) {
 return n >= t || e.includes(i);
 });
 for (var i = new Set(), n = 0; n < Qn.length; n++) {
 var r = Qn[n];
 Mn(r.startTime, r.processingEnd).forEach(function (e) {
 i.add(e);
 });
 }
 var s = zn.length - 1 - 50;
 ((zn = zn.filter(function (e, t) {
 return (e.startTime > An && t > s) || i.has(e);
 })),
 (Xn = -1));
 };
 kn.push(
 ...
 e.interactionId &&
 e.target &&
 !In.has(e.interactionId) &&
 In.set(e.interactionId, e.target);
 },
 function (e) {
 var t,
 ...
 t = t || {};
 var i = Ji("TTFB"),
 n = tn(e, i, Bn, t.reportAllChanges);
 Vn(function () {
 var r = Bi();
 r &&
 ((i.value = Math.max(r.responseStart - Ki(), 0)),
 (i.entries = [r]),
 n(!0),
 Gi(function () {
 ((i = Ji("TTFB", 0)),
 (n = tn(e, i, Bn, t.reportAllChanges))(!0));
 }));
 });
 },
 ...
 processingStart: Ln.timeStamp + Nn,
 };
 ...
 r = function () {
 (removeEventListener("pointerup", i, Yn),
 removeEventListener("pointercancel", n, Yn));
 };
 (addEventListener("pointerup", i, Yn),
 addEventListener("pointercancel", n, Yn));
 })(t, e)
 : Hn(t, e);
 }
 },
 ...
 a = en("first-input", o);
 ((i = tn(e, r, er, t.reportAllChanges)),
 a &&
 (rn(
 sn(function () {
 (o(a.takeRecords()), a.disconnect());
 ...
 var t = e.entries[0],
 i = {
 eventTarget: Yi(t.target),
 eventType: t.name,
 eventTime: t.startTime,
 eventEntry: t,
 loadState: Vi(t.startTime),
 };
 return Object.assign(e, { attribution: i });
 })(t);
 e(i);
 }, t);
 };
 const ir = "load_state",
 nr = "time_to_first_byte";
 class rr {
 constructor(e, t) {
 ...
 r > n.value &&
 ((n.value = r), (n.entries = s), i()));
 },
 a = en("layout-shift", o);
 a &&
 ((i = tn(e, n, gn, t.reportAllChanges)),
 rn(function () {
 (o(a.takeRecords()), i(!0));
 }),
 Gi(function () {
 ...
 this.addIfPresent(s, "largest_shift_time", n));
 const o = this.buildInitialContext(e);
 (this.addIfPresent(o, ir, t),
 this.addIfPresent(o, "largest_shift_target", r),
 ...
 s = Math.max(0, i.responseStart - r);
 t = {
 timeToFirstByte: s,
 firstByteToFCP: e.value - s,
 loadState: Vi(e.entries[0].startTime),
 navigationEntry: i,
 fcpEntry: n,
 };
 }
 ...
 this.addIfPresent(r, nr, i));
 const s = this.buildInitialContext(e);
 (this.addIfPresent(s, ir, n), this.pushMeasurement(r, s));
 },
 {
 reportAllChanges:
 null === (e = this.webVitalConfig) || void 0 === e
 ...
 s = this.buildInitialValues(e);
 this.addIfPresent(s, "event_time", t);
 const o = this.buildInitialContext(e);
 (this.addIfPresent(o, "event_target", i),
 this.addIfPresent(o, "event_type", n),
 this.addIfPresent(o, ir, r),
 this.pushMeasurement(s, o));
 },
 {
 reportAllChanges:
 ...
 var e;
 !(function (e, t) {
 (Fi || (Fi = en("long-animation-frame", Un)),
 En(function (t) {
 var i = (function (e) {
 var t = e.entries[0],
 i = Cn.get(t),
 ...
 l = (a && a.target) || In.get(t.interactionId),
 u = [t.startTime + t.duration, r].concat(
 o.map(function (e) {
 ...
 processingDuration: r - n,
 presentationDelay: Math.max(c - r, 0),
 loadState: Vi(t.startTime),
 };
 ...
 o = en("largest-contentful-paint", s);
 if (o) {
 i = tn(e, r, qn, t.reportAllChanges);
 var a = sn(function () {
 Fn[r.id] ||
 (s(o.takeRecords()),
 o.disconnect(),
 ...
 o = Math.max(0, i.responseStart - n),
 a = Math.max(
 o,
 s ? (s.requestStart || s.startTime) - n : 0,
 ),
 l = Math.max(a, s ? s.responseEnd - n : 0),
 u = Math.max(l, r.startTime - n);
 ((t = {
 element: Yi(r.element),
 timeToFirstByte: o,
 ...
 this.addIfPresent(o, nr, r));
 const a = this.buildInitialContext(e);
 (this.addIfPresent(a, "element", s),
 ...
 r = Math.max((i.workerStart || i.fetchStart) - n, 0),
 s = Math.max(i.domainLookupStart - n, 0),
 ...
 this.addIfPresent(o, "waiting_duration", r),
 ...
 var t;
 const i = null !== (t = Ye($t, Be)) && void 0 !== t ? t : Ue;
 return {
 id: e.id,
 rating: e.rating,
 ...
 ? void 0
 : t.webVitalsInstrumentation) || void 0 === i
 ? void 0
 : i.trackAttribution)
 ? new Mi(
 ...
 n &&
 n.id !==
 (null === (t = this.notifiedSession) || void 0 === t
 ? void 0
 : t.id)
 ) {
 if (
 ...
 return (
 this.api.pushEvent("session_extend", {}, void 0, {
 skipDedupe: !0,
 }),
 void (this.notifiedSession = n)
 );
 ((this.notifiedSession = n),
 this.api.pushEvent(it, {}, void 0, { skipDedupe: !0 }));
 }
 }
 ...
 const r = null == c ? void 0 : c.sessionMeta,
 s = Object.assign(
 Object.assign(
 {},
 null === (i = t.session) || void 0 === i
 ? void 0
 : i.overrides,
 ),
 ...
 null ===
 (i =
 null === (t = G.config) || void 0 === t
 ? void 0
 : t.sessionTracking) || void 0 === i
 ? void 0
 : i.generateSessionId) || void 0 === n
 ? void 0
 : n.call(i)) && void 0 !== r
 ? r
 : tt(),
 ...
 u = ot({ sessionId: e, isSampled: st() });
 const i =
 null === (o = t.session) || void 0 === o
 ? void 0
 : o.overrides;
 ...
 const r = i.sessionMeta;
 ((this.notifiedSession = r),
 this.api.setSession(r),
 n === it &&
 this.api.pushEvent(it, {}, void 0, { skipDedupe: !0 }),
 n === nt &&
 this.api.pushEvent(nt, {}, void 0, { skipDedupe: !0 }));
 }
 ...
 ? n
 : Ue,
 toView: null !== (r = s.name) && void 0 !== r ? r : Ue,
 },
 void 0,
 { skipDedupe: !0 },
 ),
 ...
 this.api.pushEvent("securitypolicyviolation", y(e));
 }
 }
 class ur extends vt {
 constructor(e = {}) {
 ...
 ? void 0
 : t.errorSerializer);
 ((this.errorSerializer = r
 ? null !==
 (n =
 null === (i = this.options) || void 0 === i
 ? void 0
 : i.errorSerializer) && void 0 !== n
 ? n
 : A
 : U),
 X.HT.filter((e) => {
 ...
 type: n,
 stackFrames: r,
 } = Ft(t, this.errorSerializer);
 this.api.pushLog(
 i ? [ur.consoleErrorPrefix + i] : t,
 {
 level: e,
 context: {
 value: null != i ? i : "",
 type: null != n ? n : "",
 stackFrames: (null == r ? void 0 : r.length)
 ? A(r)
 : "",
 },
 },
 );
 } else this.api.pushLog(t, { level: e });
 else {
 const {
 value: e,
 type: i,
 ...
 new Error(ur.consoleErrorPrefix + e),
 );
 this.api.pushError(
 new Error(ur.consoleErrorPrefix + e),
 { type: i, stackFrames: n },
 );
 }
 } catch (e) {
 this.logError(e);
 } finally {
 this.unpatchedConsole[e](...t);
 }
 };
 }));
 }
 ...
 function cr(e = {}) {
 const t = [new Dt(), new Vt(), new sr(), new or(), new ar()];
 return (
 !1 !== e.enablePerformanceInstrumentation && t.unshift(new It()),
 !1 !== e.enableContentSecurityPolicyInstrumentation &&
 t.push(new lr()),
 !1 !== e.captureConsole &&
 t.push(
 new ur({ disabledLevels: e.captureConsoleDisabledLevels }),
 ),
 t
 );
 }
 ((ur.defaultDisabledLevels = [X.$b.DEBUG, X.$b.TRACE, X.$b.LOG]),
 ...
 function hr(e, { trackUserActionsPreview: t }) {
 return e.filter(
 (e) =>
 !(
 "@grafana/faro-web-sdk:instrumentation-user-action" ===
 ...
 function fr(e) {
 var t, i;
 const { page: n, generatePageId: r } =
 null !== (t = null == e ? void 0 : e.pageTracking) &&
 void 0 !== t
 ? t
 : {},
 s = [
 _e,
 De({ generatePageId: r, initialPageMeta: n }),
 ...(null !== (i = e.metas) && void 0 !== i ? i : []),
 ];
 return f(window.k6) ? [...s, Re] : s;
 }
 function pr({ trackGeolocation: e, sessionTracking: t }) {
 var i;
 const n = {};
 return (
 h(e) && (n.geoLocationTrackingEnabled = e),
 O(n)
 ? {}
 : {
 session: Object.assign(
 Object.assign(
 {},
 null !== (i = null == t ? void 0 : t.session) &&
 void 0 !== i
 ? i
 : {},
 ),
 ...
 var t;
 const i = [],
 n = B(e.unpatchedConsole, e.internalLoggerLevel);
 e.transports
 ? ((e.url || e.apiKey) &&
 n.error(
 ...
 i.push(...e.transports))
 : e.url
 ? i.push(new mt({ url: e.url, apiKey: e.apiKey }))
 : n.error('either "url" or "transports" must be defined');
 const {
 dedupe: r = !0,
 eventDomain: s = ae,
 globalObjectKey: o = se,
 instrumentations: a = cr(),
 internalLoggerLevel: l = q,
 isolate: u = !1,
 logArgsSerializer: c = U,
 metas: d = fr(e),
 paused: h = !1,
 preventGlobalExposure: f = !1,
 unpatchedConsole: p = F,
 trackUserActionsPreview: g = !1,
 trackUserActionsDataAttributeName: m = Ce,
 url: v,
 } = e,
 b = dr(e, [
 "dedupe",
 ...
 batching: Object.assign(Object.assign({}, oe), e.batching),
 dedupe: r,
 globalObjectKey: o,
 instrumentations: hr(a, e),
 internalLoggerLevel: l,
 isolate: u,
 logArgsSerializer: c,
 metas: d,
 parseStacktrace: Pe,
 ...
 eventDomain: s,
 ignoreUrls: [
 ...(null !== (t = e.ignoreUrls) && void 0 !== t ? t : []),
 ...(v ? [v] : []),
 /\/collect(?:\/[\w]*)?$/,
 ],
 ...
 if (!e) return;
 const { environment: t, faroUrl: i, appName: n } = e,
 { apps: r, bootData: s } = mr.config,
 o = r[Or.s_].version,
 a = s.user.email;
 xr(
 gr({
 url: i,
 app: { name: n, release: o, version: wr.t, environment: t },
 user: { email: a },
 ...
 trace() {
 var e;
 (u(this, d, h).call(this, "trace", []),
 null === (e = (0, r.n1)()) ||
 void 0 === e ||
 e.api.pushLog([], { level: n.$b.TRACE }));
 }
 debug(...e) {
 var t;
 (u(this, d, h).call(this, "debug", e),
 null === (t = (0, r.n1)()) ||
 void 0 === t ||
 t.api.pushLog(e, { level: n.$b.DEBUG }));
 }
 info(...e) {
 var t;
 (u(this, d, h).call(this, "info", e),
 null === (t = (0, r.n1)()) ||
 void 0 === t ||
 t.api.pushLog(e, { level: n.$b.INFO }));
 }
 log(...e) {
 var t;
 (u(this, d, h).call(this, "log", e),
 null === (t = (0, r.n1)()) ||
 void 0 === t ||
 t.api.pushLog(e, { level: n.$b.LOG }));
 }
 warn(...e) {
 var t;
 (u(this, d, h).call(this, "warn", e),
 null === (t = (0, r.n1)()) ||
 void 0 === t ||
 t.api.pushLog(e, { level: n.$b.WARN }));
 }
 error(e, t) {
 var i;
 (u(this, d, h).call(this, "error", [e]),
 t && u(this, d, h).call(this, "error", ["Error context", t]),
 null === (i = (0, r.n1)()) ||
 void 0 === i ||
 i.api.pushError(e, { context: t }));
 }
 constructor() {
 var e, t;
 (o((e = this), (t = d)),
 ...
 var n = i(9851);
 function r(e) {
 const t = n.K3.parse(e),
 i = new Set(),
 r = t.cursor();
 do {
 if (r.type.is("VectorSelector") && r.firstChild()) {
 do {
 if (r.type.is("Identifier")) {
 const t = e.slice(r.from, r.to);
 t && i.add(t);
 }
 } while (r.nextSibling());
 r.parent();
 ...
 : "MatchOp" === s.type.name
 ? (n = t.slice(s.from, s.to))
 : "StringLiteral" === s.type.name &&
 (r = t.slice(s.from + 1, s.to - 1));
 return i && n ? { label: i, op: n, value: r } : null;
 }
 },
 4137: (e, t, i) => {
 "use strict";
 i.d(t, { Gy: () => s, bw: () => o, s_: () => r });
 var n = i(2533);
 const r = n.id,
 s = `/a/${n.id}`,
 o = { Trail: "trail", Drilldown: "drilldown" };
 },
 5176: (e, t, i) => {
 "use strict";
 i.d(t, { t: () => n });
 const n = "8cda36a15bfaf0a30f108b7694668d6f02d35f79";
 },
 5438: (e, t, i) => {
 "use strict";
 var n;
 ...
 const r = n.LOG,
 s = [n.TRACE, n.DEBUG, n.INFO, n.LOG, n.WARN, n.ERROR];
 },
 5959: (e) => {
 "use strict";
 e.exports = s;
 ...
 return null;
 const i = n.find(({ regExp: e }) => e.test(window.location.host));
 ...
 Z = function (e, t) {
 for (var i, n, r, a, u, c, d = 0; d < t.length && !u; ) {
 var h = t[d],
 f = t[d + 1];
 ...
 if (V(t[i][n], e)) return "?" === i ? s : i;
 } else if (V(t[i], e)) return "?" === i ? s : i;
 ...
 [p, W],
 d,
 [f, H, { tablet: ["p10001l", "w7001"], "*": "mobile" }],
 ],
 ...
 J = function (e, t) {
 if (
 (typeof e === l && ((t = e), (e = s)), !(this instanceof J))
 )
 return new J(e, t).getResult();
 var i = typeof r !== a && r.navigator ? r.navigator : s,
 ...
 var e = {};
 return ((e[m] = s), Z.call(e, n, w.cpu), e);
 }),
 ...
 var e = {};
 return ((e[h] = s), (e[g] = s), Z.call(e, n, w.engine), e);
 }),
 (this.getOS = function () {
 var e = {};
 return (
 ...
 return (
 (n = typeof e === u && e.length > 500 ? Y(e, 500) : e),
 this
 );
 }),
 this.setUA(n),
 ...
 var ee = typeof r !== a && (r.jQuery || r.Zepto);
 if (ee && !ee.ua) {
 var te = new J();
 ((ee.ua = te.getResult()),
 (ee.ua.get = function () {
 ...
 t.push(n ? new u(i.name, n, i.id, i.flags) : i);
 }
 return new c(t);
 }
 }
 ...
 r = new T(n);
 return (r.moveTo(e, t), d.set(this, r._tree), r);
 }
 get topNode() {
 return new w(this, 0, 0, null);
 }
 resolve(e, t = 0) {
 let i = b(d.get(this) || this.topNode, e, t, !1);
 return (d.set(this, i), i);
 }
 resolveInner(e, t = 0) {
 let i = b(h.get(this) || this.topNode, e, t, !0);
 ...
 r = null;
 for (
 let e = n instanceof w ? n : n.context.parent;
 e;
 e = e.parent
 )
 if (e.index < 0) {
 ...
 u = Array.isArray(i) ? new g(i, i.length) : i,
 c = r.types,
 d = 0,
 h = 0;
 function f(e, t, i, n, o, p) {
 let { id: g, start: x, end: k, size: S } = u,
 P = h,
 T = d;
 for (; S < 0; ) {
 if ((u.next(), -1 == S)) {
 let t = a[g];
 return (i.push(t), void n.push(x - e));
 }
 if (-3 == S) return void (d = g);
 if (-4 == S) return void (h = g);
 ...
 Q = c[g],
 C = x - e;
 if (k - x <= s && (z = y(u.pos - t, o))) {
 let t = new Uint16Array(z.size - z.skip),
 i = u.pos - z.size,
 n = t.length;
 for (; u.pos > i; ) n = $(z.start, t, n);
 ((E = new m(t, k - z.start, r)), (C = z.start - e));
 } else {
 let e = u.pos - S;
 u.next();
 let t = [],
 ...
 let e = b(Q, T);
 E = A(Q, t, i, 0, t.length, 0, k - x, e, e);
 } else E = w(Q, t, i, k - x, P - k, T);
 }
 (i.push(E), n.push(C));
 }
 function v(e, t, i, n) {
 ...
 l = -1;
 for (; u.pos > t; ) {
 let { id: e, start: t, end: i, size: n } = u;
 if (n > 4) u.next();
 else {
 if (l > -1 && t < l) break;
 ...
 (t[i++] = o[e + 2] - s),
 (t[i++] = i));
 (i.push(new m(t, o[2] - s, r)), n.push(s - e));
 }
 }
 function b(e, t) {
 return (i, n, r) => {
 ...
 if (!u && s.type == e && s.length == r) return s;
 (a = s.prop(o.lookAhead)) && (l = n[u] + s.length + a);
 }
 return w(e, i, n, r, l, t);
 };
 }
 function O(e, t, i, n, s, o, a, l, u) {
 let c = [],
 d = [];
 for (; e.length > n; )
 (c.push(e.pop()), d.push(t.pop() + i - s));
 (e.push(w(r.types[a], c, d, o - s, l - o, u)), t.push(s - i));
 }
 ...
 function $(e, t, i) {
 let { id: n, start: r, end: s, size: o } = u;
 if ((u.next(), o >= 0 && n < l)) {
 let a = i;
 if (o > 4) {
 let n = u.pos - (o - 4);
 ...
 (t[--i] = r - e),
 (t[--i] = n));
 } else -3 == o ? (d = n) : -4 == o && (h = n);
 return i;
 }
 let x = [],
 k = [];
 for (; u.pos > 0; )
 f(e.start || 0, e.bufferStart || 0, x, k, -1, 0);
 let S =
 ...
 ? k[0] + x[0].length
 : 0;
 return new p(c[e.topID], x.reverse(), k.reverse(), S);
 })(e);
 }
 }
 ...
 let s = n ? 0 : f.IgnoreOverlays;
 if (n)
 for (let n = e, o = n.parent; o; n = o, o = n.parent)
 n instanceof w &&
 n.index < 0 &&
 (null === (r = o.enter(t, i, s)) || void 0 === r
 ? void 0
 : r.from) != n.from &&
 (e = o);
 for (;;) {
 ...
 let u = o[e],
 c = l[e] + s.from;
 if (v(n, i, c, c + u.length))
 if (u instanceof m) {
 if (r & f.ExcludeBuffers) continue;
 let o = u.findChild(0, u.buffer.length, t, i - c, n);
 if (o > -1) return new k(new x(s, u, e, c), null, o);
 } else if (
 r & f.IncludeAnonymous ||
 !u.type.isAnonymous ||
 E(u)
 ) {
 let o;
 if (!(r & f.IgnoreMounts) && (o = a.get(u)) && !o.overlay)
 return new w(o.tree, c, e, s);
 let l = new w(u, c, e, s);
 return r & f.IncludeAnonymous || !l.type.isAnonymous
 ? l
 : l.nextChild(
 t < 0 ? u.children.length - 1 : 0,
 t,
 i,
 n,
 );
 ...
 if (r & f.IncludeAnonymous || !s.type.isAnonymous) return null;
 if (
 ((e =
 s.index >= 0
 ? s.index + t
 ...
 if (null != i)
 for (let e = !1; !e; )
 if (((e = r.type.is(i)), !r.nextSibling())) return s;
 for (;;) {
 ...
 let n = i instanceof w && i.index < 0 ? null : i.parent,
 r = e.slice();
 return (n ? (r[t] = n) : r.splice(t, 1), new P(r, i));
 }
 class P {
 constructor(e, t) {
 ...
 t = new k(this.buffer, t, this.stack[e]);
 ...
 matchContext(e) {
 if (!this.buffer) return $(this.node.parent, e);
 let { buffer: t } = this.buffer,
 { types: i } = t.set;
 for (
 let n = e.length - 1, r = this.stack.length - 1;
 n >= 0;
 r--
 ) {
 if (r < 0) return $(this._tree, e, n);
 ...
 (e) => e instanceof m || !e.type.isAnonymous || E(e),
 );
 }
 const z = new WeakMap();
 function Q(e, t) {
 ...
 function A(e, t, i, n, r, s, o, a, l) {
 let u = 0;
 for (let i = n; i < r; i++) u += Q(e, t[i]);
 ...
 let t = n[u - 1] + i[u - 1].length - f;
 d.push(A(e, i, n, r, u, f, t, null, l));
 }
 h.push(f + a - s);
 }
 })(t, i, n, r, 0),
 ...
 l = i(2445),
 u = i(3510);
 const c = "Grafana Metrics Drilldown",
 d = [
 {
 title: `Open in ${c}`,
 description: `Open current query in the ${c} view`,
 category: "metrics-drilldown",
 icon: "gf-prometheus",
 path: m(a.bw.Drilldown),
 targets: [
 n.PluginExtensionPoints.DashboardPanelMenu,
 n.PluginExtensionPoints.ExploreToolbarAction,
 ...
 const i = e.targets.filter(b);
 if (!i.length) return;
 const n = i[0],
 s = (0, r.getTemplateSrv)(),
 o = s.replace(
 null == n || null === (t = n.datasource) || void 0 === t
 ? void 0
 : t.uid,
 e.scopedVars,
 );
 if (!n.expr) return { path: m(a.bw.Drilldown) };
 const u = s.replace(n.expr, e.scopedVars, O);
 try {
 const {
 metric: t,
 labels: i,
 ...
 n &&
 l.v.warn(
 `PromQL query has parsing errors: ${r.join(", ")}`,
 );
 const s =
 "timeRange" in e &&
 ...
 i,
 t,
 null == s ? void 0 : s.from,
 null == s ? void 0 : s.to,
 ),
 );
 return { path: m(a.bw.Drilldown, c) };
 } catch (e) {
 return (
 l.v.error(
 new Error(
 `[Metrics Drilldown] Error parsing PromQL query: ${e}`,
 ),
 ),
 { path: m(a.bw.Drilldown) }
 );
 ...
 c = p(i, u, r, s, l),
 d = t ? g(c) : void 0;
 return { path: m(a.bw.Drilldown, d) };
 },
 },
 ];
 function h(e) {
 const t = s.K3.parse(e);
 let i = "";
 const n = [];
 let r = !1;
 const o = [];
 ...
 { metric: i, labels: n, hasErrors: r, errors: o }
 );
 }
 function f(e) {
 return [v.Filters, `${e.label}|${e.op}|${e.value}`];
 }
 ...
 return (function (e) {
 if ("string" != typeof e) return e;
 if (r.config.featureToggles.prometheusSpecialCharsInLabelValues)
 return /^\w+(=|!=|=~|!~)".*"$/.test(e)
 ? e
 ...
 ? e
 : r.config.featureToggles.prometheusSpecialCharsInLabelValues
 ? e
 .replace(/\\/g, "\\\\\\\\")
 .replace(/"/g, '\\\\\\"')
 .replace(/[$^*{}\[\]\'+?.()|]/g, "\\\\$&")
 ...
 if (i) return i;
 let n = [],
 r = new o(e.name, n, e, t);
 for (let e of t) e.instances.push(r);
 let s = (function (e) {
 let t = [[]];
 for (let i = 0; i < e.length; i++)
 for (let n = 0, r = t.length; n < r; n++)
 t.push(t[n].concat(e[i]));
 return t.sort((e, t) => t.length - e.length);
 })(t);
 for (let t of e.set)
 if (!t.modified.length) for (let e of s) n.push(l.get(t, e));
 return r;
 }
 }
 const u = new r.uY();
 ...
 let l = new c(n, r, o > 0 ? i.slice(0, o) : null);
 t[a] = l.sort(t[a]);
 }
 }
 return u.add(t);
 })({
 LineComment: P.comment,
 LabelName: P.labelName,
 StringLiteral: P.string,
 NumberDurationLiteral: P.number,
 NumberDurationLiteralInDurationContext: P.number,
 ...
 floor: 393,
 histogram_count: 395,
 histogram_fraction: 397,
 histogram_quantile: 399,
 histogram_stddev: 401,
 histogram_stdvar: 403,
 histogram_sum: 405,
 histogram_avg: 407,
 double_exponential_smoothing: 409,
 hour: 411,
 idelta: 413,
 increase: 415,
 info: 417,
 ...
 max_over_time: 435,
 min_over_time: 437,
 ts_of_max_over_time: 439,
 ts_of_min_over_time: 441,
 ts_of_last_over_time: 443,
 minute: 445,
 month: 447,
 pi: 449,
 predict_linear: 451,
 present_over_time: 453,
 quantile_over_time: 455,
 rad: 457,
 rate: 459,
 resets: 461,
 round: 463,
 ...
 sort_desc: 475,
 sort_by_label: 477,
 sort_by_label_desc: 479,
 sqrt: 481,
 stddev_over_time: 483,
 stdvar_over_time: 485,
 sum_over_time: 487,
 tan: 489,
 tanh: 491,
 timestamp: 493,
 ...
 specialized: [
 { term: 57, get: (e, t) => E(e) << 1, external: E },
 {
 term: 57,
 get: (e, t) => (Q(e) << 1) | 1,
 external: Q,
 ...
 return (
 p[e].call(i.exports, i, i.exports, m),
 (i.loaded = !0),
 i.exports
 );
 }
 ...
 for (
 var r = 2 & t && e;
 ("object" == typeof r || "function" == typeof r) && !~c.indexOf(r);
 r = d(r)
 )
 Object.getOwnPropertyNames(r).forEach((t) => (n[t] = () => e[t]));
 return ((n.default = () => e), m.d(i, n), i);
 }),
 (m.d = (e, t) => {
 for (var i in t)
 m.o(t, i) &&
 ...
 (m.f = {}),
 (m.e = (e) =>
 Promise.all(Object.keys(m.f).reduce((t, i) => (m.f[i](e, t), t), []))),
 (m.u = (e) =>
 e +
 ".js?_cache=" +
 {
 78: "b47d06db0be36dfd8cc3",
 138: "e22db2b683184a3f68f2",
 140: "ec81fdf3a81f8080a8fd",
 351: "4ba15ddb202606978dfc",
 619: "d2184616561dc86728cb",
 767: "d134cf551dad48bfaf7f",
 792: "79c48dbde1c722d712fa",
 836: "3565bf1138434de8b2c8",
 944: "b4c7bab5d72bcf4cb8cf",
 }[e]),
 (m.g = (function () {
 ...
 (h = {}),
 (f = "grafana-metricsdrilldown-app:"),
 (m.l = (e, t, i, n) => {
 if (h[e]) h[e].push(t);
 else {
 var r, s;
 ...
 l.getAttribute("data-webpack") == f + i
 ) {
 r = l;
 break;
 }
 ...
 (r.timeout = 120),
 m.nc && r.setAttribute("nonce", m.nc),
 r.setAttribute("data-webpack", f + i),
 (r.src = e),
 0 !== r.src.indexOf(window.location.origin + "/") &&
 (r.crossOrigin = "anonymous"),
 (r.integrity = m.sriHashes[n]),
 (r.crossOrigin = "anonymous")),
 (h[e] = [t]));
 var u = (t, i) => {
 ...
 (m.p = "public/plugins/grafana-metricsdrilldown-app/"),
 (m.sriHashes = {
 78: "sha256-CCc6Xp9SgOVlvDqSkxbIrUREQ0bDfUYfBuxNWC/mDzw=",
 138: "sha256-V7gPM30hNdhf8/K618q8te8ou1DUiq752tkK6ET2ork=",
 140: "sha256-8FixxS4rLqiGKyYlIcGQNcL0vqsP3TDFnYZJYpHRdns=",
 351: "sha256-vmslgoG7maPS/q8wFcYOf133h4/LKdTxTxnfHDt6h10=",
 619: "sha256-PRHpZcZFpI10E2alMINDGDZjgdXwQj6+D7Fih3/YbR0=",
 767: "sha256-Q5bkSJ3/0ztTVIaPo4ut3TvpYazZRbG5l5x0Yche4ug=",
 792: "sha256-n9glSvUoslqv4tg53t94pHnbLrTU+AZ5rQm88Td1s2I=",
 836: "sha256-HoEnnGMCfYkSraf6v7/DfE1zsX7Jqpc9LtoxKYDVBjw=",
 ...
 l = 0;
 if (s.some((t) => 0 !== e[t])) {
 for (n in o) m.o(o, n) && (m.m[n] = o[n]);
 if (a) a(m);
 }
 for (t && t(i); l < s.length; l++)
 ((r = s[l]), m.o(e, r) && e[r] && e[r][0](), (e[r] = 0));
 },
 ...
 s = m.n(r);
 const o = (0, r.lazy)(() =>
 Promise.all([m.e(944), m.e(138), m.e(836), m.e(140)]).then(
 m.bind(m, 7140),
 ),
 );
 const a = [
 {
 id: `${m(2533).id}/label-breakdown-component/v1`,
 title: "Label Breakdown",
 description:
 "A metrics label breakdown view from the Metrics Drilldown app.",
 component: (e) =>
 s().createElement(
 r.Suspense,
 { fallback: s().createElement("div", null, "Loading...") },
 s().createElement(o, e),
 ),
 },
 ];
 ...
 { default: t } = yield m.e(944).then(m.bind(m, 6944));
 if (e())
 try {
 yield t();
 } catch (e) {
 u.v.error(e, {
 message: "Error while initializing outlier detection",
 });
 }
 else
 u.v.warn("WASM not supported, outlier detection will not work");
 return Promise.all([
 m.e(944),
 m.e(138),
 m.e(792),
 ...
 h = new i.AppPlugin().setRootPage((e) =>
 s().createElement(
 r.Suspense,
 {
 fallback: s().createElement(n.LoadingPlaceholder, { text: "" }),
 },
 s().createElement(d, e),
 ),
 );
 for (const e of l.Ge) h.addLink(e);
 for (const e of a) h.exposeComponent(e);
 })(),
 v
 );
 })());
