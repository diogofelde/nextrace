...
define([
 ...
 return (
 f[e].call(o.exports, o, o.exports, m),
 (o.loaded = !0),
 o.exports
 );
 }
 ...
 e +
 ".js?_cache=" +
 { 133: "09d2255b91c2ad7b05ea", 958: "0ca8b6c68e4d18a82233" }[e]),
 (m.g = (function () {
 ...
 if (void 0 !== o)
 for (
 var i = document.getElementsByTagName("script"), p = 0;
 p < i.length;
 p++
 ) {
 var s = i[p];
 ...
 (m.sriHashes = {
 133: "sha256-LVTOyL0oF3WmscXUEZoP4tZ4m2CxhWoiFCGze0ceMxA=",
 958: "sha256-Zq5fs8znmZ2lWvdq6i4WUYyCxW7iK7VkAAvtDyJfQRU=",
 }),
 (() => {
 var e = { 231: 0 };
 m.f.j = (r, o) => {
 ...
 var t = new Promise((o, t) => (a = e[r] = [o, t]));
 o.push((a[2] = t));
 var n = m.p + m.u(r),
 i = new Error();
 m.l(
 ...
 for (r && r(o); s < n.length; s++)
 ((t = n[s]), m.o(e, t) && e[t] && e[t][0](), (e[t] = 0));
 },
 o = (self.webpackChunkgrafana_pyroscope_app =
 self.webpackChunkgrafana_pyroscope_app || []);
 (o.forEach(r.bind(null, 0)), (o.push = r.bind(null, o.push.bind(o))));
 })());
 var y = {};
 (m.r(y), m.d(y, { plugin: () => O }));
 var v = m(1308),
 h = m.n(v);
 m.p =
 h() && h().uri
 ...
 u = l ? `&var-serviceName=${l}` : "",
 d = `&var-profileMetricId=${n.profileTypeId}`,
 f = `&explorationType=${s}`;
