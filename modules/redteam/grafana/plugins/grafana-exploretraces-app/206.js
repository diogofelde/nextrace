...
(self.webpackChunkgrafana_exploretraces_app =
 ...
 "Remover filtro com a chave {{keyLabel}} ",
 },
 "adhoc-filters-combobox": {
 "remove-filter-value":
 "Remover o valor do filtro - {{itemLabel}} ",
 "use-custom-value": "Utilizar valor personalizado: {{itemLabel}}",
 },
 "fallback-page": {
 content:
 "Se chegou aqui atravs de um link, pode existir um erro nesta aplicao.",
 ...
 "button-tooltip": "Ativar a comparao de intervalos de tempo",
 },
 splitter: {
 "aria-label-pane-resize-widget":
 "Widget de redimensionamento de painel",
 },
 ...
 "O plugin do painel no tem componente de painel",
 },
 "viz-panel-series-limit": {
 "content-rendering-series-single-panel-impact-performance":
 "A renderizao de demasiadas sries num nico painel pode afetar o desempenho e dificultar a leitura dos dados. ",
 "warning-message": "A mostrar apenas {{seriesLimit}} sries",
 },
 },
 utils: {
 ...
 tooltip:
 "Aplicado por predefinio neste painel de controlo. Em caso de edio,  transferido para outros painis de controlo.",
 ...
 formats: {
 description: {
 "commaseparated-values": "Valores separados por vrgulas",
 "double-quoted-values": "Valores entre aspas duplas",
 "format-date-in-different-ways":
 "Formatar a data de diferentes formas",
 "format-multivalued-variables-using-syntax-example":
 "Formatar variveis de valores mltiplos com a sintaxe glob, exemplo {value1,value2}",
 ...
 "loading-options": "A carregar opes...",
 },
