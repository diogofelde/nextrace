...
(self.webpackChunkgrafana_exploretraces_app =
 ...
 "Filter bewerken met sleutel {{keyLabel}}",
 "managed-filter": "{{origin}} beheerde filter",
 "remove-filter-with-key":
 "Filter verwijderen met sleutel {{keyLabel}}",
 },
 ...
 "collapse-button-label": "Scne samenvouwen",
 "expand-button-label": "Scne uitvouwen",
 "remove-button-label": "Scne verwijderen",
 },
 "scene-debugger": {
 "object-details": "Objectdetails",
 "scene-graph": "Scnegrafiek",
 "title-scene-debugger": "Scne-debugger",
 },
 "scene-grid-row": {
 ...
 "Paneelplug-in heeft geen paneelcomponent",
 },
 "viz-panel-series-limit": {
 "content-rendering-series-single-panel-impact-performance":
 "Het renderen van te veel reeksen in n paneel kan de prestaties benvloeden en de leesbaarheid van de gegevens verminderen. ",
 ...
 "Datum op verschillende manieren opmaken",
 ...
 "Handig voor URL-escaping-waarden",
 "values-are-separated-by-character":
 "Waarden worden gescheiden door | teken",
 },
 },
 },
